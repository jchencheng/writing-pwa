...
export const defaultUnits: PracticeUnit[] = [
  {
    ...
    practices: [
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'inform', options: ['inform', 'tell', 'notify', 'educate'] },
          { id: 'b2', correctAnswer: 'about', options: ['about', 'of', 'on', 'regarding'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'increase', options: ['increase', 'boost', 'raise', 'enhance'] },
          { id: 'b2', correctAnswer: 'sales', options: ['sales', 'revenue', 'profits', 'income'] },
          { id: 'b3', correctAnswer: 'stimulate', options: ['stimulate', 'boost', 'drive', 'promote'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'creative', options: ['creative', 'innovative', 'imaginative', 'original'] },
          { id: 'b2', correctAnswer: 'industry', options: ['industry', 'sector', 'field', 'domain'] },
          { id: 'b3', correctAnswer: 'employment', options: ['employment', 'job', 'work', 'career'] },
          { id: 'b4', correctAnswer: 'opportunities', options: ['opportunities', 'chances', 'positions', 'roles'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'unemployment', options: ['unemployment', 'joblessness', 'idleness', 'inactivity'] },
          { id: 'b2', correctAnswer: 'rate', options: ['rate', 'level', 'percentage', 'figure'] },
          { id: 'b3', correctAnswer: 'viable', options: ['viable', 'sustainable', 'feasible', 'workable'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'manipulates', options: ['manipulates', 'persuades', 'encourages', 'influences'] },
          { id: 'b2', correctAnswer: 'artificial', options: ['artificial', 'false', 'fake', 'unreal'] },
          { id: 'b3', correctAnswer: 'needs', options: ['needs', 'wants', 'desires', 'demands'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'sell', options: ['sell', 'promote', 'market', 'pitch'] },
          { id: 'b2', correctAnswer: 'dreams', options: ['dreams', 'ideals', 'aspirations', 'hopes'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'dissatisfied', options: ['dissatisfied', 'unhappy', 'discontented', 'frustrated'] },
          { id: 'b2', correctAnswer: 'consumer', options: ['consumer', 'luxury', 'expensive', 'desired'] },
          { id: 'b3', correctAnswer: 'goods', options: ['goods', 'products', 'items', 'things'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'vulnerable', options: ['vulnerable', 'susceptible', 'sensitive', 'receptive'] },
          { id: 'b2', correctAnswer: 'negative', options: ['negative', 'harmful', 'detrimental', 'adverse'] },
          { id: 'b3', correctAnswer: 'impacts', options: ['impacts', 'effects', 'influences', 'consequences'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'bright', options: ['bright', 'vibrant', 'colorful', 'lively'] },
          { id: 'b2', correctAnswer: 'colours', options: ['colours', 'colors', 'hues', 'shades'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'pester', options: ['pester', 'nag', 'bother', 'annoy'] },
          { id: 'b2', correctAnswer: 'detrimental', options: ['detrimental', 'harmful', 'damaging', 'injurious'] },
          { id: 'b3', correctAnswer: 'to', options: ['to', 'for', 'with', 'on'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'mitigate', options: ['mitigate', 'reduce', 'alleviate', 'lessen'] },
          { id: 'b2', correctAnswer: 'impose', options: ['impose', 'enforce', 'put', 'place'] },
          { id: 'b3', correctAnswer: 'strict', options: ['strict', 'severe', 'stringent', 'rigorous'] },
          { id: 'b4', correctAnswer: 'restrictions', options: ['restrictions', 'limits', 'regulations', 'controls'] }
        ],
      ...
      },
      {
        ...
        blanks: [
          { id: 'b1', correctAnswer: 'junk', options: ['junk', 'unhealthy', 'processed', 'fast'] },
          { id: 'b2', correctAnswer: 'food', options: ['food', 'snacks', 'meals', 'products'] },
          { id: 'b3', correctAnswer: 'strictly', options: ['strictly', 'completely', 'fully', 'totally'] },
          { id: 'b4', correctAnswer: 'prohibited', options: ['prohibited', 'banned', 'forbidden', 'outlawed'] }
        ],
